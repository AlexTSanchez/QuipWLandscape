...
public class GestionContenidoL extends Gestion<ContenidoLista> {
    ...
    public Cursor getCursor() {
        return this.getCursor(ContratoBaseDatos.TablaContenidoLista.TABLA, ContratoBaseDatos.TablaLista.PROJECTION_ALL, ContratoBaseDatos.TablaLista.SORT_ORDER_DEFAULT);
    }
